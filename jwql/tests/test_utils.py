...
FILENAME_PARSER_TEST_DATA = [
    ...
    ('jw01193-c1000_t001_miri_f2550w-brightsky_i2d.fits',
        {'program_id': '01193',
         'ac_id': 'c1000',
         'target_id': 't001',
         'instrument': 'miri',
         'optical_elements': 'f2550w',
         'subarray': 'brightsky',
         'suffix': 'i2d',
         'recognized_filename': True,
         'filename_type': 'stage_3_optelement_subarray',
         'file_root': 'jw01193-c1000_t001_miri_f2550w-brightsky',
         'detector': 'Unknown',
         'group_root': 'jw01193-c1000_t001_miri_f2550w-brightsky',
         'observation': '026'}),

    # Test full stage 3 MIRI c-based, no subarray
    ('jw01193-c1000_t001_miri_f2550w_i2d.fits',
        {'program_id': '01193',
         'ac_id': 'c1000',
         'target_id': 't001',
         'instrument': 'miri',
         ...
         'recognized_filename': True,
         'filename_type': 'stage_3_target_id',
         'file_root': 'jw01193-c1000_t001_miri_f2550w',
         'detector': 'Unknown',
         'group_root': 'jw01193-c1000_t001_miri_f2550w',
         'observation': '026'}),
