...
sect = 'dark_monitor|monitor_cron_jobs|monitor_mast|generate_preview_images|monitor_filesystem|test_logging_functions'
...
urlpatterns = [
    ...
    re_path(r'^(?P<log_type>({}))/(?P<sect>({}))/$'.format(log_type, sect), views.view_log, name='view_log'),
